...
import 'package:welcome/photos.dart';
            ...
            child: InkWell(
                onTap: () {
                  Navigator.of(context)
                      .push(MaterialPageRoute(builder: (context) => const HoToDo()));
                },
                child: Container(
                  width: 284,
                  height: 80,
            ...
            child: InkWell(
                onTap: () {
                  Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => const WhatIfeel()));
                },
                child: Container(
                    width: 284,
                    height: 80,
                    color: const Color.fromRGBO(165, 127, 255, 0.699999988079071),
